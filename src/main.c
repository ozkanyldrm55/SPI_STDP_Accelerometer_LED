...
*                                               	  *
*@Dosya        :SPI                      			  *
*@Açıklama     :SPI ile accelerometer kullanarak      *
*@Açıklama      kart uzerindeki ledleri yak   	      *
*                                      				  *
*                                               	  *
...
*               Test Edilmiştir
*
*http://www.elektrohobim.com/index.php/arduino/46-spi-haberlesme-protokolu        		  *
*******************************************************/
#include "stm32f4xx.h"
...
/**************************************************************************************
Fonksiyon:delay_ms
Amaç     :Gecikme icin kullanılır
Kullanım :delay_ms(uint16_t delay)
***************************************************************************************/
...
/**************************************************************************************
Fonksiyon:SPI_Config
Amaç     :Kullanılan sistemin GPIO ayarlamalarını yapar
Kullanım :SPI_Config(void);
**************************************************************************************/
...
void SPI_Config(void)
{
	...
	SPIStructure.SPI_Mode = SPI_Mode_Master  ; //stm karti master olucak
...
/**************************************************************************************
Fonksiyon: SPI_Rx
Amaç     : SPI dan veri almak icin kullanilir.
Kullanım : SPI_Rx(uint8_t adress)
**************************************************************************************/
...
/**************************************************************************************
Fonksiyon: SPI_Tx
Amaç     : SPI ile veri transferi icin kullanilir
Kullanım : SPI_Tx(uint8_t adress , uint8_t data)
**************************************************************************************/
